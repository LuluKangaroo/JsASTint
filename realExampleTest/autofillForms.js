...
var autofillForms = {
	...
	initialize: function() {
		...
		var just_installed = this.autofillFormsPrefs.getIntPref("just_installed");
		if(just_installed < 2){
			gBrowser.selectedTab = gBrowser.addTab(this.autofillFormsPrefs.getCharPref("post_install_url"));
			this.autofillFormsPrefs.setIntPref("just_installed", just_installed + 1);
		}
